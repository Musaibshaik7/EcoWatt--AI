...
#         # Chart selector centered with charts (not in sidebar)
#         chart_options = st.multiselect(
#             "Select charts:",
#             ["Solar", "Wind", "Temperature", "Battery", "Cost", "Map"],
#             default=["Solar", "Wind", "Temperature", "Battery", "Cost", "Map"]
#         )
